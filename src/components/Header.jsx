...
function Header() {
    ...
    return (
        <div className='header-container'>
            ...
            <img className='header-logo' src="https://res.cloudinary.com/dqiryahpb/image/upload/v1715689571/g0en3eyom34z1rtvskws.png" alt="logo" />
            ...
            <div className={showSideBar ? "header-sidebar-moblie" : "header-sidebar-moblie show"}>
